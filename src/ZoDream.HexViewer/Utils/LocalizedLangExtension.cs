...
namespace ZoDream.HexViewer.Utils
{
    ...
    public class LocalizedLangExtension : MarkupExtension, INotifyPropertyChanged
    {
        ...
        public void Init()
        {
            // 本地化语言资源文件根名，声明语言文件 ZoDream.HexViewer/Strings/Resource.zh-CN.resx
            ResourceManager = new ResourceManager("ZoDream.HexViewer.Strings.Resource", typeof(LocalizedLangExtension).Assembly);
        ...
        {
            CultureInfo culture = new(language.Contains("zh") ? "zh-CN" : "en-US");
